...
// extern bool NEUROenable; // from main.c
// void NEUROinit(void)
// {
// 	Serial.begin(115200); 
// 	NEUROenable = 1;
...
// unsigned int attention, meditation;
// unsigned int eegValues[8];
...
// 		}// clean buffer until start of the fist command


// 		Serial.readBytesUntil('\n',Buffer,bSize); 

// 		//json = Serial.readStringUntil('\n');
// // str.toCharArray(json, 200);
...
// 			{
// 				Serial.println("neuro detected");

// 				attention = root["n"]["a"];
// 				meditation = root["n"]["m"];
// 				// eegValues[0] = root["neuro"]["e1"];
// 				// eegValues[1] = root["neuro"]["e2"];
// 				// eegValues[2] = root["neuro"]["e3"];
// 				// eegValues[3] = root["neuro"]["e4"];
// 				// eegValues[4] = root["neuro"]["e5"];
// 				// eegValues[5] = root["neuro"]["e6"];
// 				// eegValues[6] = root["neuro"]["e7"];
// 				// eegValues[7] = root["neuro"]["e8"];
// 			}

// 		if (root.containsKey("r"))//remote data
// 		{
// 			Serial.println("test detected");

// 				// attention = root["neuro"]["a"];
// 				// meditation = root["neuro"]["m"];
// 				// eegValues[0] = root["neuro"]["e1"];
// 				// eegValues[1] = root["neuro"]["e2"];
// 				// eegValues[2] = root["neuro"]["e3"];
// 				// eegValues[3] = root["neuro"]["e4"];
...
// 		if (Serial.available()>0) {NEUROEventRun();}//еще раз парсим буффер если там что-то осталось
// 	}
// }
...
// 	if (requestedData<8)
// 	{
// 		return eegValues[requestedData];
// 	}

// 	else if (requestedData==8)
// 	{
// 		return attention;
// 	}
// 	else if (requestedData==9)
// 	{
// 		return meditation;
// 	}
// 	else return 0;
...
//         if (containsNestedKey(it->value.as<JsonObject>(), key)) 
//             return true;
//     }
